...
class login_signup_form extends moodleform implements renderable, templatable {
    function definition() {
        ...
        $mform->addElement('text', 'username', 'CPF', 'maxlength="11" size="12"');
        ...
        //     'username', 
        //     format_string('CPF'), 
        //     'maxlength="11" id="profilefield_cpf" pattern="[0-9]{11}" data-tip="Informe o CPF (apenas números)" title="Apenas números"' 
        // ); 
