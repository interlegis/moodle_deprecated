...
#panel-right {background: inherit}';
    ...
    // Set the slide delay.
    $name = 'theme_elegance/slidedelay';
    $title = get_string('slidedelay' , 'theme_elegance');
    $description = get_string('slidedelaydesc', 'theme_elegance');
    $default = '600';
    $setting = new admin_setting_configtext($name, $title, $description, $default );
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    // Interlegis url setting.
    $name = 'theme_elegance/interlegis';
    $title = get_string('interlegis', 'theme_elegance');
    $description = get_string('interlegisdesc', 'theme_elegance');
    $default = 'http://wwwinterlegis.leg.br/';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);

    // ILB url setting.
    $name = 'theme_elegance/ilb';
    $title = get_string('ilb', 'theme_elegance');
    $description = get_string('ilbdesc', 'theme_elegance');
    $default = 'http://www.senado.leg.br/ilb';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);

    // ABEL url setting.
    $name = 'theme_elegance/abel';
    $title = get_string('abel', 'theme_elegance');
    $description = get_string('abeldesc', 'theme_elegance');
    $default = 'http://www.portalabel.org.br/';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);

    // Senado url setting.
    $name = 'theme_elegance/senado';
    $title = get_string('senado', 'theme_elegance');
    $description = get_string('senadodesc', 'theme_elegance');
    $default = 'http://www.senado.leg.br/';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);

    // TCU url setting.
    $name = 'theme_elegance/tcu';
    $title = get_string('tcu', 'theme_elegance');
    $description = get_string('tcudesc', 'theme_elegance');
    $default = 'http://www.tcu.gov.br/';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);

    // Camara url setting.
    $name = 'theme_elegance/camara';
    $title = get_string('camara', 'theme_elegance');
    $description = get_string('camaradesc', 'theme_elegance');
    $default = 'http://www.camara.leg.br/';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
